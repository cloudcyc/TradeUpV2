...
function EditShopProductDetails({ navigation }){
        ...
        <ScrollView style={styles.root}>
            ...
            <View>
                ...
                <View style={styles.sectionStyle}>
                    ...
                    <Ionicons name='pricetag-outline' size={25} style={{paddingLeft:5, paddingRight:5}} />
                    <TextInput
                        style={styles.textInputStyle}
                        placeholder="Enter Price Here in RM"
                        underlineColorAndroid="transparent"
...
export default EditShopProductDetails